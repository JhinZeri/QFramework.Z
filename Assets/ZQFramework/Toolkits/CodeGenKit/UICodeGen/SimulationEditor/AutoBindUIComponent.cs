...
namespace ZQFramework.Toolkits.CodeGenKit.UICodeGen.SimulationEditor
{
    public static class AutoBindUIComponent
    {
        ...
        public static void AutoBindComponent2UICanvasView()
        {
            ...
            if (cSharpAssembly != null)
            {
                ...
                var canvasGameObject =
                    (EditorUtility.InstanceIDToObject(UICodeGenProcessLogInfo.Instance.LatestAnalysisData
                                                                             .CanvasViewInstanceId) as RectTransform)?.gameObject;
            ...
            {
                Debug.LogError(
                    "程序集设置错误，请到 Assets/ZQFramework/Toolkits/CodeGenKit/UICodeGen/SimulationEditor/AutoBindUIComponent.cs 中修改");
            }
