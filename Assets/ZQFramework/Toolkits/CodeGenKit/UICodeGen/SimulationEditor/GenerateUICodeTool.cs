...
namespace ZQFramework.Toolkits.CodeGenKit.UICodeGen.SimulationEditor
{
    public static class GenerateUICodeTool
    {
        ...
        // [MenuItem("GameObject/生成 UI 组件脚本", priority = 0)]
        ...
        // [MenuItem("GameObject/生成 UI 组件脚本", true, priority: 0)]
        static bool ParseAndCreateUIScriptsValidator()
        {
        ...
        static string ReplaceTimestamp(string originalScript, string newTimestamp)
        {
            ...
            // 在原始脚本中查找匹配的时间戳信息
            Match match = regex.Match(originalScript);
        ...
        private static string ProcessLogicScriptAddition(string originScriptPath)
        {
            // 读取原 Logic 代码
