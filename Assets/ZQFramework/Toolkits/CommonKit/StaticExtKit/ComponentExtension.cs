...
namespace ZQFramework.Toolkits.CommonKit.StaticExtKit
{
    ...
    {
        /// <summary>
        /// Gets <typeparamref name="T" /> component from <paramref name="component" />'s game object. If it no exist, new one will
        /// be created.
        /// </summary>
        ...
        /// <param name="includeInactive"> 是否查找隐藏的物体上的组件 / Should we find component on inactive game objects? </param>
        /// <returns> <see langword="true" /> if component was found. </returns>
        public static bool TryGetComponentInChildren<T>(this Component sourceComponent, out T component,
        ...
        /// <param name="includeInactive"> 是否查找隐藏的物体上的组件 / Should we find component on inactive game objects? </param>
        /// <returns> <see langword="true" /> if component was found. </returns>
        public static bool TryGetComponentInParent<T>(this Component sourceComponent, out T component,
            bool includeInactive = false) where T : Component
        {
