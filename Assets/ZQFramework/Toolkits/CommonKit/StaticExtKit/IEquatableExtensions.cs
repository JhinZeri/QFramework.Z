...
namespace ZQFramework.Toolkits.CommonKit.StaticExtKit
{
    public static class IEquatableExtensions
    {
        ...
        /// <returns>
        /// <see langword="true" /> if the all element of <paramref name="values" /> are equals to
        /// <paramref name="value" />.
        /// </returns>
        ...
        /// <param name="values"> Array with objects to compare. </param>
        /// <returns>
        /// <see langword="true" /> if at least one of all elements of <paramref name="values" /> are equals to
        /// <paramref name="value" />.
        /// </returns>
