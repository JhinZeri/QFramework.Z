...
namespace ZQFramework.Toolkits.CommonKit.StaticExtKit
{
    public static class RectTransformExtensions
    {
        ...
        public static void SetPivotOnlyX(this RectTransform rectTransform, float x)
        {
            ...
            rectTransform.SetAnchoredPositionX(rectTransform.anchoredPosition.x -
                                               rectTransform.sizeDelta.x * deltaPercent);
        }
        ...
        public static void SetPivotOnlyY(this RectTransform rectTransform, float y)
        {
            ...
            rectTransform.SetAnchoredPositionY(rectTransform.anchoredPosition.y -
                                               rectTransform.sizeDelta.y * deltaPercent);
        }
