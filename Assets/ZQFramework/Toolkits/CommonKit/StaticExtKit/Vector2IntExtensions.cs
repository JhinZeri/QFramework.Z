...
namespace ZQFramework.Toolkits.CommonKit.StaticExtKit
{
    public static class Vector2IntExtensions
    {
        ...
        /// <param name="points"> Compared points. </param>
        /// <returns> Closest point tuple info. </returns>
        public static (Vector2Int point, int index) GetClosestPoint(this Vector2Int point,
        ...
        public static (Vector2 point, float distance) GetClosestPointOnRay(this Vector2Int point, Vector2 origin,
            Vector2 direction)
        {
        ...
        public static (Vector2 point, float distance) GetClosestPointOnSegment(this Vector2Int point, Vector2 start,
            Vector2 end)
        {
