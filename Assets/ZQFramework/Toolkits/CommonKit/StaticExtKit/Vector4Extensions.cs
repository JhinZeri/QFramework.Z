...
namespace ZQFramework.Toolkits.CommonKit.StaticExtKit
{
    public static class Vector4Extensions
    {
        ...
        {
            return With(vector, 0, value.x, 1, value.y);
        }
        ...
        {
            return With(vector, 0, value.x, 2, value.y);
        }
        ...
        {
            return With(vector, 0, value.x, 3, value.y);
        }
        ...
        {
            return With(vector, 1, value.x, 2, value.y);
        }
        ...
        {
            return With(vector, 1, value.x, 3, value.y);
        }
        ...
        {
            return With(vector, 2, value.x, 3, value.y);
        }
        ...
        /// <returns> Changed copy of the vector. </returns>
        public static Vector2 With(this Vector4 vector, int axis1, float value1, int axis2, float value2, int axis3,
            float value3)
        {
            vector[axis1] = value1;
            vector[axis2] = value2;
        ...
        {
            return With(vector, 0, x, 1, y, 2, z);
        }
        ...
        {
            return With(vector, 0, value.x, 1, value.y, 2, value.z);
        }
        ...
        {
            return With(vector, 0, x, 1, y, 3, w);
        }
        ...
        {
            return With(vector, 0, value.x, 1, value.y, 3, value.z);
        }
        ...
        {
            return With(vector, 0, x, 2, z, 3, w);
        }
        ...
        {
            return With(vector, 0, value.x, 2, value.y, 3, value.z);
        }
        ...
        {
            return With(vector, 1, y, 2, z, 3, w);
        }
        ...
        {
            return With(vector, 1, value.x, 2, value.y, 3, value.z);
        }
        ...
        static void Compare(Vector4 vector, ref int index, int compareIndex, int result)
        {
            if (vector[compareIndex].CompareTo(vector[index]) == result)
                index = compareIndex;
        }

        static int CompareAllComponents(Vector4 vector, int result)
        {
            var index = 0;
        ...
        {
            return new Vector4(Mathf.Clamp01(vector.x), Mathf.Clamp01(vector.y), Mathf.Clamp01(vector.z),
        ...
        {
            return vector.x.Approximately(vector.y) && vector.y.Approximately(vector.z) &&
                   vector.z.Approximately(vector.w);
        }
    }
}