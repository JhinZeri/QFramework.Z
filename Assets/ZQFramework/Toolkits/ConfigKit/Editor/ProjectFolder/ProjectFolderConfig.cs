...
namespace ZQFramework.Toolkits.ConfigKit.Editor.ProjectFolder
{
    ...
    public class ProjectFolderConfig : ScriptableObject, IConfigOrSettingOrLogInfo
    {
        ...
        {
            if (!Directory.Exists(CurrentArchitecturePath))
            {
                Directory.CreateDirectory(CurrentArchitecturePath);
            }

            if (!Directory.Exists(CurrentControllerPath))
            {
                Directory.CreateDirectory(CurrentControllerPath);
            }
            ...
            if (!Directory.Exists(CurrentSystemPath))
            {
                Directory.CreateDirectory(CurrentSystemPath);
            }

            if (!Directory.Exists(CurrentUtilityPath))
            {
                Directory.CreateDirectory(CurrentUtilityPath);
            }

            if (!Directory.Exists(CurrentUICodePath))
            {
                Directory.CreateDirectory(CurrentUICodePath);
            }

            if (!Directory.Exists(CurrentUIPrefabPath))
            {
                Directory.CreateDirectory(CurrentUIPrefabPath);
            }
