...
namespace ZQFramework.Toolkits.CoroutineKit.Core
{
    /// <summary>
    /// 表示当前 EasyCoroutine 的状态
    /// </summary>
    [Flags]
    public enum State
    {
    ...
    /// <summary>
    /// 更加强大的 Coroutine 封装。可以控制执行，订阅事件，获取最后结果，等待特定事件，等等。
    /// </summary>
    [Serializable]
    public sealed class EasyCoroutine
    {
        #region 变量
        ...
        /// <summary>
        /// EasyCoroutine 是否有特定的拥有者。<br/>
        /// 如果有，那么当拥有者被销毁时，EasyCoroutine 也会自动被销毁。<br/>
        /// 如果没有，则会被收集进入全局的 EasyCoroutinePool 中。此时算作无主 EasyCoroutine
        /// </summary>
        public bool IsOwned { get; private set; }

        /// <summary>
        /// EasyCoroutine 的最后一个返回结果
        /// </summary>
        public object LastResult => _enumerator?.Current;

        /// <summary>
        /// 是否在在完成后自动销毁。<br/>
        /// 如果是 IEnumerator 类型，则会被忽略，无法设置此项，因为 IEnumerator 类型的 Coroutine 会在执行完毕后自动销毁。
        /// </summary>
        ...
        State m_State = State.Reseted;

        /// <summary>
        /// EasyCoroutine 提供给外界查看的状态
        /// </summary>
        public State CurrentState
        {
            ...
            private set
            {
                ...
                var stateEvent = m_State switch
                {
                    ...
                    var _ => throw new PlayControlException("Wrong EasyCoroutine state.")
                };
        ...
        internal class CompleteAwaiter : MoroutineAwaiter
        {
            ...
            public override bool KeepWaiting => _enumerator == _moroutine._enumerator &&
                                                !(_moroutine.IsCompleted || _moroutine.IsDestroyed);
        }
        ...
        private EasyCoroutine(GameObject owner, IEnumerable enumerable)
        {
            ...
            Owner = owner.TryGetComponent(out MoroutinesOwner existingOwner)
                ? existingOwner
                : owner.AddComponent<MoroutinesOwner>();
            Owner.Add(this);
        ...
        /// <returns>Unowned moroutines.</returns>
        public static List<Moroutine> GetUnownedMoroutines(State mask) =>
            MoroutinesExecuter.Instance.gameObject.GetMoroutines(mask);
        ...
        public static Moroutine Create(IEnumerator enumerator) =>
            Create(new EnumerableEnumerator(enumerator)).SetAutoDestroy(true);
        ...
        /// <returns><inheritdoc cref="Create(IEnumerator)"/></returns>
        public static Moroutine Create(Component ownersComponent, IEnumerator enumerator) =>
            Create(ownersComponent, new EnumerableEnumerator(enumerator)).SetAutoDestroy(true);
        ...
        /// <returns><inheritdoc cref="Create(IEnumerator)"/></returns>
        public static Moroutine Create(Component ownersComponent, IEnumerable enumerable) =>
            Create(ownersComponent.gameObject, enumerable);
        ...
        /// <param name="enumerator"><inheritdoc cref="Create(IEnumerator)"/></param>
        /// <returns><inheritdoc cref="Create(IEnumerator)"/></returns>
        public static Moroutine Create(GameObject owner, IEnumerator enumerator) =>
            Create(owner, new EnumerableEnumerator(enumerator)).SetAutoDestroy(true);
        ...
        /// <param name="enumerator"><inheritdoc cref="Create(IEnumerator)"/></param>
        /// <returns><inheritdoc cref="Create(IEnumerator)"/></returns>
        public static Moroutine Run(IEnumerator enumerator) =>
            Run(new EnumerableEnumerator(enumerator)).SetAutoDestroy(true);
        ...
        /// <returns><inheritdoc cref="Create(IEnumerator)"/></returns>
        public static Moroutine Run(Component ownersComponent, IEnumerator enumerator) =>
            Run(ownersComponent, new EnumerableEnumerator(enumerator)).SetAutoDestroy(true);
        ...
        /// <param name="enumerable"><inheritdoc cref="Create(IEnumerable)"/></param>
        /// <returns><inheritdoc cref="Create(IEnumerator)"/></returns>
        public static Moroutine Run(Component ownersComponent, IEnumerable enumerable) =>
            Run(ownersComponent.gameObject, enumerable);
        ...
        /// <param name="enumerator"><inheritdoc cref="Create(IEnumerator)"/></param>
        /// <returns><inheritdoc cref="Create(IEnumerator)"/></returns>
        public static Moroutine Run(GameObject owner, IEnumerator enumerator) =>
            Run(owner, new EnumerableEnumerator(enumerator)).SetAutoDestroy(true);
        ...
        public static List<Moroutine> Create(params IEnumerator[] enumerators) =>
            SetAutoDestroy(Create(enumerators.Select(e => new EnumerableEnumerator(e)).ToArray()));
        ...
        /// <returns><inheritdoc cref="Create(IEnumerator[])"/></returns>
        public static List<Moroutine> Create(Component ownersComponent, params IEnumerator[] enumerators) =>
            SetAutoDestroy(Create(ownersComponent, enumerators.Select(e => new EnumerableEnumerator(e)).ToArray()));
        ...
        /// <returns><inheritdoc cref="Create(IEnumerator[])"/></returns>
        public static List<Moroutine> Create(Component ownersComponent, params IEnumerable[] enumerables) =>
            Create(ownersComponent.gameObject, enumerables);
        ...
        /// <param name="enumerators"><inheritdoc cref="Create(IEnumerator[])"/></param>
        /// <returns><inheritdoc cref="Create(IEnumerator[])"/></returns>
        public static List<Moroutine> Create(GameObject owner, params IEnumerator[] enumerators) =>
            SetAutoDestroy(Create(owner, enumerators.Select(e => new EnumerableEnumerator(e)).ToArray()));
        ...
        /// <param name="enumerables"><inheritdoc cref="Create(IEnumerable[])" path="/param[@name='enumerables']"/></param>
        /// <returns><inheritdoc cref="Create(IEnumerator[])"/></returns>
        public static List<Moroutine> Create(GameObject owner, params IEnumerable[] enumerables) =>
            enumerables.Select(e => new Moroutine(owner, e)).ToList();
        ...
        /// <param name="enumerators"><inheritdoc cref="Create(IEnumerator[])"/></param>
        /// <returns><inheritdoc cref="Create(IEnumerator[])"/></returns>
        public static List<Moroutine> Run(params IEnumerator[] enumerators) =>
            SetAutoDestroy(Run(enumerators.Select(e => new EnumerableEnumerator(e)).ToArray()));
        ...
        /// <returns><inheritdoc cref="Create(IEnumerator[])"/></returns>
        public static List<Moroutine> Run(Component ownersComponent, params IEnumerator[] enumerators) =>
            SetAutoDestroy(Run(ownersComponent, enumerators.Select(e => new EnumerableEnumerator(e)).ToArray()));
        ...
        /// <param name="enumerables"><inheritdoc cref="Create(IEnumerable[])"/></param>
        /// <returns><inheritdoc cref="Create(IEnumerator[])"/></returns>
        public static List<Moroutine> Run(Component ownersComponent, params IEnumerable[] enumerables) =>
            Run(ownersComponent.gameObject, enumerables);
        ...
        /// <param name="enumerators"><inheritdoc cref="Create(IEnumerator[])"/></param>
        /// <returns><inheritdoc cref="Create(IEnumerator[])"/></returns>
        public static List<Moroutine> Run(GameObject owner, params IEnumerator[] enumerators) =>
            SetAutoDestroy(Run(owner, enumerators.Select(e => new EnumerableEnumerator(e)).ToArray()));
        ...
        public Moroutine Run(bool rerunIfCompleted = true)
        {
            ...
            {
                if (Owner == null)
                    throw new PlayControlException(
                        $"Moroutine couldn't be started because the game object's Owner component is missing.");

                if (!Owner.gameObject.activeInHierarchy)
                    throw new PlayControlException(
                        $"Moroutine couldn't be started because the game object '{Owner.name}' is deactivated.");
            }
            ...
            if (IsCompleted)
            {
                if (!rerunIfCompleted)
                    throw new PlayControlException(
                        "Moroutine was completed. If you want to restart it, call \"Reset\" method before.");
        ...
        public Moroutine SetOwner(GameObject gameObject)
        {
            ...
            {
                Owner = gameObject.TryGetComponent(out MoroutinesOwner existingOwner)
                    ? existingOwner
                    : gameObject.AddComponent<MoroutinesOwner>();
                Owner.Add(this);
                IsOwned = true;
