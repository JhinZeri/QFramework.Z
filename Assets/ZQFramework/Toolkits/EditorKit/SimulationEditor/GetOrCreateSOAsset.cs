...
{
    public class GetOrCreateSOAsset
    {
        /// <summary>
        ...
        public static T GetSingleSOAndDeleteExtraUseAssetDatabase<T>(string path) where T : ScriptableObject
        {
            ...
            if (guids.Length > 0)
            {
                ...
                if (wantToAsset == null) Debug.LogWarning("GetSingleSOAndDeleteExtraUseAssetDatabase 中加载资源失败");
