...
{
    public partial class UIViewGenTest : CanvasView
    {
        #region UI 自定义生命周期 
        ...
        void OnPasswordInputFieldValueChange(string value){ }
        void OnPasswordInputFieldValueEditEnd(string value){ }
        void OnGOOToggleValueChange(bool isOn, Toggle toggle){ }
