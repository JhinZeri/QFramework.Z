...
namespace ZQFramework.Toolkits.UnityEditorKit.Editor.Tools.HierarchyColorCardTool
{
    /// <summary>
    /// 卡片颜色设计列表
    /// </summary>
        ...
        public static HierarchyPrefixColorCardConfig Instance
        {
            get
            {
                ...
                m_Instance = GetOrCreateScriptableObject
                    .GetSingletonAssetOnPathAssetDatabase<HierarchyPrefixColorCardConfig>(CONFIG_ROOT_PATH);
                return m_Instance;
            }
        }
